                ...
                <section>
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl font-bold">
                                    Master the Art of Roller Skating
                                </h1>
                                <p className="mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                                    Join Tiger Roller Skaters, a vibrant community in Nairobi where passion meets skill. Learn from experienced coaches and skate with friends.
                                </p>
                        ...
                        <div className="aspect-[2/3] absolute inset-1 overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5">
                            <img
                                alt="Roller skaters in action"
                                className="size-full object-cover opacity-80"
                                src="https://d2xsxph8kpxj0f.cloudfront.net/310519663402898195/kgAVhJswmeuxjzz8evqx4U/hero-roller-skating-action-YQT5mZJToGvupN2GrkUJyA.webp"
                            />
                        </div>
                    </div>
                </section>
                    ...
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm font-medium">Trusted by skaters</p>
                            </div>
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                <InfiniteSlider
                                    ...
                                    <div className="flex items-center justify-center">
                                        <span className="text-sm font-semibold text-muted-foreground">🛼 Nairobi</span>
                                    </div>
                                    <div className="flex items-center justify-center">
                                        <span className="text-sm font-semibold text-muted-foreground">🏆 Professional</span>
                                    </div>
                                    <div className="flex items-center justify-center">
                                        <span className="text-sm font-semibold text-muted-foreground">👥 Community</span>
                                    </div>
                                    <div className="flex items-center justify-center">
                                        <span className="text-sm font-semibold text-muted-foreground">⚡ Dynamic</span>
                                    </div>
                                    <div className="flex items-center justify-center">
                                        <span className="text-sm font-semibold text-muted-foreground">🎯 Skilled</span>
                                    </div>
                                </InfiniteSlider>
